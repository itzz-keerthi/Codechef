'''TASK
Problem
Write a program to obtain 2 numbers (( AA andand BB )) and an arithmetic operator (C)(C) and then design a calculatorcalculator depending upon the operator entered by the user.
...
Output:
Output a single line containing the answer, obtained by, performing the operator on the numbers. Your output will be considered to be correct if the difference between your output and the actual answer is not more than 10^{-6}10 
−6
 .
